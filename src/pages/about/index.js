...
The application itself is open-source and can be accessed on its Github repository
          <a href="https://github.com/WhitmanCSCapstone/bmac-warehouse">here</a>
. Its built using React for the front-end, and has a NoSQL database hosted on Google’s Firebase.
        </p>
